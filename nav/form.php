...
<div class="conteudo_loja fundo_cinza pai_limitado">
    <div class="conteudo_limitado">
        <div id="conteudo_institucional" class="dados">

            <h1 id="titulo_institucional">Cotação de Preços</h1>
            <div id="form-cotacao">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($cotacao[ 'itens' ] as $item) { ?>
                                        <tr>
                                            ...
                                            <td><input type="number" name="qtde[]" value="<?= $item[ 'qtde' ] ?>"
                                                       min="0">
                                            </td>
                                        </tr>
                                    <?php } ?>
