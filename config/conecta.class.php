...
class Conecta
{
    ...
    public function __construct( $qualTabela = '' )
    {
        ...
        } else if ( preg_match( '/192\.168\.[0-9]{2}\.[0-9]{2}:[0-9]{4}/', $tipo_conexao ) ) {
     ...
     * @access public
     *
     * @param string  $sql    Código MySQL para quando se for executar outras operações. Se declarado, demais variáveis
     *                        serão ignoradas.
     * @param boolean $oneRow Quando true, retorna apenas 1 linha da query, em forma de objeto. Quando false, retorna
     *                        uma array com todas as linhas da query em forma de objeto
     */
